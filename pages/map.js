...
export default function Home({ ...props }) {
  ...
  return (
    <div>
      <Head>
        <title>Access GIS - tinkerchild</title>
      </Head>
      <div className="flex relative">
        <div className="absolute bottom-4 left-4 bg-white rounded-2xl p-2 shadow-2xl z-30">
          <Drawer />
        </div>
        <div className="absolute right-4 top-4 bg-white rounded-2xl p-2 shadow-2xl z-30">
            <div className="flex items-center">
              <div className="w-4 h-4 rounded-full mr-2 bg-[orange]">
              </div>
              <p>Normal Ship</p>
            </div>
            <div className="flex items-center">
              <div className="w-4 h-4 rounded-full mr-2 bg-[purple]">
              </div>
              <p>Troller Ship</p>
            </div>
            <div className="flex items-center">
              <div className="w-4 h-4 rounded-full mr-2 bg-[green]">
              </div>
              <p>Pole and line Ship</p>
            </div>
        </div>
